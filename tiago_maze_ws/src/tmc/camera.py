...
from v2.srv import ProcessImg, ProcessImgResponse
...
class MyCamera:
    ...
    def callback_ServiceCamera(self,request):
        ...
        if r_count>4100 and g_count<1000:
            res.result = 1
            return res.result
        elif g_count>6000 and r_count<1000:
            res.result = 2
            return res.result
        else:
            res.result = 0
...
if __name__ == '__main__':
    ...
    camera = MyCamera()
    camera_service = rospy.Service("camera_service",ProcessImg, camera.callback_ServiceCamera)
